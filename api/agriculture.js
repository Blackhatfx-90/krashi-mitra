...
function localAnswer(query, ctx) {
  ...
  const hi = [
    ...
    [/भाव|price|मंडी|mandi|rate/, 'ताज़ा मंडी भाव के लिए इंटरनेट चाहिए। नेट आने पर ऐप आधिकारिक स्रोत से भाव ले आएगी; तब तक eNAM या Agmarknet पर देख लें।'],
    [/खाद|fertilizer|यूरिया|urea/, 'खाद की मात्रा मिट्टी जाँच और फसल की अवस्था के अनुसार रखें। सूखी मिट्टी पर ज़्यादा यूरिया न डालें।'],
    [/दवा|pesticide|कीटनाशक|medicine/, 'दवा हमेशा डिब्बे के लेबल के अनुसार ही मिलाएँ। दस्ताने और मास्क पहनें, हवा की उल्टी दिशा में छिड़काव न करें। मात्रा कृषि अधिकारी से पक्की कर लें।'],
    [/नमस्ते|hello|मदद|help/, 'नमस्ते! मैं खेती, मौसम, मंडी, सरकारी योजना — या कोई भी और सवाल — में मदद कर सकता हूँ।'],
  ];
  const hit = hi.find(([re]) => re.test(t));
  if (hit) return hit[1];
  return (ctx.name ? ctx.name + ' जी, ' : '') +
    'अभी इंटरनेट नहीं है, इसलिए पूरा जवाब नहीं दे पा रहा। नेट आने पर यही सवाल दोबारा पूछिए।';
}
