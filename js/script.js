    ...
    classes: {
      ...
      rice_tungro: {
        ...
        symptoms:
          ...
          'पीलापन पत्ती की नोक से शुरू होकर नीचे आता है। कल्ले कम बन���े हैं और बालियाँ छोटी, खाली रह जाती हैं��� ' +
      ...
      rice_bakanae: {
        ...
        actions: [
          ...
          'खड़ी फसल में छिड़काव से खास फायदा नहीं — पौधे हटाना ही मुख्य उप���य है',
      ...
      rice_stem_rot: {
        ...
        organic: [
          ...
          'खेत को बीच-���ीच में सुखाएँ (alternate wetting and drying)',
      ...
      rice_planthopper: {
        ...
        speech:
          ...
          'क्योंकि वे ��सके दुश्मन कीट मार देती हैं और फुदका और ��ढ़ जाता है। ' +
      ...
      Rice_stem_borer: {
        ...
        chemical: [
          ...
          'या क्���ोरएंट्रानिलिप्रोल 18.5 SC — लगभग 0.3 मि.ली. प्रति लीटर पानी',
    ...
    classes: {
      ...
      wheat_mite: {
        ...
        speech:
          ...
          'म���त्रा और दवा की पुष्टि अपने कृषि विज्ञान केंद्र से ज़रूर कर लें।',
      },
      ...
      wheat_mildew: {
        ...
        pathogen: 'क��क / Fungus — Blumeria (Erysiphe) graminis f.sp. tritici',
        severity: 'medium', severityHi: 'मध्यम नुकसान',
        risk: 'medium', riskHi: 'मध्यम जोखिम / Medium Risk',
        actions: [
      ...
      wheat_fusarium: {
        ...
        prevention: [
          ...
          'खेत से फसल अवशेष ह��ाएँ या पूरी तरह सड़ाएँ',
          'कटाई के बाद हल्के/सिकुड़े दाने पंखे या ग्रेडर से अलग कर दें',
          'अनाज 12% से कम नमी पर सुखाकर भंडारण करें',
        ],
        speech:
          'पहचाना गया रोग है फ्यूजेरियम बाली झुलसा, जिसे हे�� ब्लाइट या स्कैब भी कहते हैं। ' +
          ...
          'कटाई के बाद खेत में फसल अ��शेष न छोड़ें और गेहूँ के बाद मक्का लगाने से बचें। ' +
          'मात्रा और दवा की पुष्टि अपने कृषि विज्ञान केंद्र से ज़रूर कर लें।',
      },
      ...
      wheat_black_rust: {
        ...
        risk: 'high', riskHi: 'बहुत ज़्यादा जोखिम / Very High Risk',
        actions: [
          'तुरंत टेबुकोनाज़ोल या प्रोपिकोनाज़ोल ~1 मि.ल��./लीटर छिड़कें',
        ...
        symptoms:
          'तने, पत्ती-आवरण (sheath) और कभी-कभी बाली पर गहरे भूरे-लाल, लंबे और उभरे हुए फफोले बन���े हैं। ' +
      ...
      wheat_stem_fly: {
        ...
        chemical: [
          ...
          'विकल्प: थायामेथोक्सम 25 WG — लगभग 0.2 ग्र��म प्रति लीटर पानी; कटाई से 30 दिन पहले रोक दें',
        ],
        prevention: [
    ...
    classes: {
      ...
      sugarcane_red_rot: {
        ...
        note:
          ...
          'रोगग्रस्त झुंड उखाड़कर जलाना और अगली बार स्वस्थ बीज + रोग-रोधी किस्म ���ी असली बचाव है।',
        actions: [
      ...
      sugarcane_grassy_shoot: {
        ...
        chemical: [
          'फैलाने वाले चूसने वाले कीटों के लिए इ��िडाक्लोप्रिड लगभग 0.3 मि.ली. प्रति लीटर पानी',
      ...
      sugarcane_yellow_leaf: {
        ...
        speech:
          ...
          'इसकी पक्की पहचान यह है कि पत्ती को पलटकर देखिए, नीचे की तरफ बी��� वाली नस पीली या गुलाबी पीली पड़ जाती है ' +
    ...
    classes: {
      ...
      Cotton_Pink_Bollworm: {
        ...
        speech:
          ...
          'यह बाहर से लगभग दिखती नहीं, इसीलिए खतरनाक है। पहचान यह है कि फूल पू���ा खुलता नहीं और गुलाब की कली जैसा बंद रह जाता है। ' +
          ...
          'ध्यान रखिए, बी ट�� कपास पर भी यह अब लगती है। और कटाई के बाद बचे डोडे व लकड़ी खेत में मत छोड़िए, सुंडी उसी में सर्दी काटती है। ' +
          'मात्रा और दवा की पुष्टि अपने कृषि विज्ञान केंद्र से ज़रूर कर लें।',
      },
      ...
      'Cotton_Mealy _Bug': {
        ...
        organic: [
          ...
          'क्रिप्ट��लेमस बीटल 100 प्रति एकड़ छोड़ें (मित्र कीट, मिलीबग खाता है)',
      ...
      'Cotton_Thirps ': {
        ...
        speech:
          ...
          'नीम तेल पाँच मिलीलीटर प्रति लीटर पानी का छिड़काव करें, और दवा पत्ती की ��िचली सतह पर ज़रूर पहुँचनी चाहिए। ' +
      ...
      'Cotton_bollrot ': {
        ...
        actions: [
          ...
          '��ॉपर ऑक्सीक्लोराइड 3 ग्राम/लीटर पानी छिड़कें',
    ...
    classes: {
      ...
      onion_bulb_blight: {
        ...
        symptoms:
          ...
          'ऊपर की पत्तियाँ पीली पड़कर गिरने लगती है�� और पौधा आसानी से उखड़ जाता है। ' +
      ...
      onion_virosis: {
        ...
        speech:
          ...
          'ध्यान रखिए, विषाणु रोग का कोई सीधा इलाज नहीं होता। ' +
          'अभी करने वाला काम यह है कि रोगग्रस्त ��ौधे उखाड़कर खेत से बाहर नष्ट कर दें, ' +
      ...
      onion_purple_blotch: {
        ...
        actions: [
          'मैंकोज़ेब लगभग 2.5 ग्राम प्रति लीटर पानी + स्टिकर मिलाकर छ���ड़कें',
      ...
      onion_stemphylium_leaf_blight: {
        ...
        symptoms:
          'पत्���ी के बीच वाले हिस्से पर छोटे हल्के पीले-भूरे धब्बे बनते हैं जो बढ़कर लंबे और गहरे भूरे-काले हो जाते हैं। ' +
        ...
        organic: [
          'नीम का तेल लगभग 5 मि.ली. प्रति लीटर पानी',
          'फसल चक्र अपनाएँ',
          'कतारों के बीच दूरी रखें ���ाकि हवा चले',
        ],
        chemical: [
          'मैंकोज़ेब 75 WP — लगभग 2.5 ग्राम प्रति लीटर पानी',
      ...
      onion_caterpillar: {
        ...
        chemical: [
          'क्लोरएंट्रानिलिप्रोल 18.5 SC — लगभग 0.3 मि.ली. प्रति लीटर पानी',
          'या इमामेक्टिन ब��ंजोएट 5 SG — लगभग 0.4 ग्राम प्रति लीटर पानी',
          'छिड़काव शाम को करें, तब इल्ली बाहर निकलती है',
        ],
        prevention: [
          'खेत और मेड़ की खरपतवार साफ रखें',
        ...
        speech:
          ...
          'अभी करने वाला काम यह है कि शाम को खेत घूमकर इल्ल���याँ हाथ से बीनकर नष्ट कर दें, ' +
      ...
      onion_botrytis_leaf_light: {
        ...
        speech:
          ...
          'और हर धब्बे के चारों ओर हल्का पानी ज��सा घेरा रहता है। ' +
          'अभी करने वाला काम यह है कि मैंकोज़ेब लगभग ढाई ग्राम प्रति लीटर पानी में स्टिकर मिलाकर छिड़कें, ' +
  ...
  maize: {
    ...
    classes: {
      ...
      Maize_Ear_Rot: {
        ...
        organic: [
          'रोग-रोधी और मज़बू�� आवरण (husk cover) वाली किस्में लगाएँ',
    ...
    classes: {
      ...
      Potato_Blackleg: {
        ...
        symptoms:
          ...
          'ऊपर की पत्तियाँ पीली पड़कर ऊपर की ओर मुड़ जाती हैं और पौधा मुरझा जात��� है। ' +
      ...
      Potato_Common_Scab: {
        ...
        organic: [
          ...
          'मिट्टी को हल्का अम्लीय रख���ं, चूना न डालें',
        ],
        chemical: [
      ...
      Potato_Healthy: {
        ...
        speech:
          ...
          'और हर दस पंद्रह दिन पर भंडार की जाँच करके सड़े कंद ��िकालते रहिए।',
      },
      ...
      Potato_Pink_Rot: {
        ...
        symptoms:
          ...
          'काटकर हवा में रखने पर कटा हुआ गूदा पहले सामन जैसा गुलाबी होता है, फिर भूरा और अंत ��ें काला पड़ जाता है — यही पक्की पहचान है। ' +
    ...
    classes: {
      ...
      Tomato_Early_blight: {
        ...
        organic: [
          ...
          'पौधों ���ो सहारा दें ताकि पत्तियाँ मिट्टी को न छुएँ',
        ],
        chemical: [
          'मैंकोज़ेब 75 WP — लगभग 2.5 ग्राम प्रति लीटर पानी',
      ...
      Tomato_Leaf_Mold: {
        ...
        chemical: [
          'मैंकोज़ेब 75 WP — लगभग 2.5 ग्राम प्रति लीटर पा���ी',
          'या क्लोरोथैलोनिल — लगभग 2 ग्राम प्रति लीटर पानी',
        ],
        prevention: [
      ...
      'Tomato_Spider_mites Two-spotted_spider_mite': {
        ...
        organic: [
          ...
          'नीम का तेल लगभग 5 मि.ली. प्रत��� लीटर पानी',
      ...
      Tomato_Yellow_Leaf_Curl_Virus: {
        ...
        symptoms:
          ...
          'पौधा बौना और झाड़ीनुमा हो जात��� है, फूल झड़ जाते हैं और फल लगते ही नहीं या बहुत कम लगते हैं। ' +
        ...
        speech:
          'पहचाना गया रोग है पत्ती मरोड़ विषाणु, जिसे टी वाई एल सी वी कहते हैं। यह स��ेद मक्खी से फैलता है। ' +
    ...
    classes: {
      ...
      Mango_Bacterial_Canker: {
        ...
        speech:
          ...
          'उपचार के लिए स्ट्रेप्टोसाइक्लिन शून्य दशमलव एक ग्राम और कॉपर ऑक्सीक्लोराइड तीन ग्राम प्रति लीटर पानी मिलाकर छिड़काव करें। ' +
          '��ोगग्रस्त टहनियाँ स्वस्थ हिस्से से दस सेंटीमीटर नीचे से काटकर जला दीजिए। ' +
      ...
      Mango_Die_Back: {
        ...
        symptoms:
          ...
          'पहले ऊपर की पत्तियाँ भूरी होकर मुरझाती हैं और लट�� जाती हैं, पर पेड़ से गिरती नहीं (सूखी पत्तियाँ लटकी रहती हैं) — ' +
      ...
      Mango_Powdery_Mildew: {
        ...
        organic: [
          ...
          'गिरे बौर और पत्ते हटाकर जला द��ं',
        ],
        chemical: [
        ...
        speech:
          ...
          'एक ज़रूरी बात — जब फूल पूरे खिले हों तब छिड़काव मत कीजिए, वरना मधुमक्खियाँ मर ��ाएँगी और परागण ही नहीं होगा। ' +
          'मात्रा और दवा की पुष्टि अपने कृषि विज्ञान केंद्र से ज़रूर कर लें।',
      },
      ...
      Mango_Sooty_Mould: {
        ...
        symptoms:
          ...
          'नुकसान यह है कि काली परत धू��� रोक देती है, जिससे पत्ती भोजन नहीं बना पाती, पेड़ कमज़ोर होता है और ' +
        ...
        chemical: [
          ...
          'फल तोड़ने से 20 दिन पहले सारा छ��ड़काव बंद कर दें',
        ],
        prevention: [
      ...
      Mango_Gall_Midge: {
        ...
        symptoms:
          ...
          'ज़���यादा गाँठें बनने पर पत्ती टेढ़ी होकर सूख जाती है और गिर जाती है। ' +
    ...
    classes: {
      ...
      Apple_Rust: {
        ...
        actions: [
          ...
          'मैंकोजेब ~2.5 ग्राम/लीटर या माइक्लोब्यूटा��िल ~0.4 ग्राम/लीटर',
      ...
      Apple_Alternaria_Leaf_Spot: {
        ...
        chemical: [
          'मैं��ोजेब 75 WP — लगभग 2.5 ग्राम प्रति लीटर पानी',
          'विकल्प: कॉपर ऑक्सीक्लोराइड 50 WP — लगभग 3 ग्राम प्रति लीटर पानी',
          'विकल्प: कार्बेन्डाजिम 50 WP — लगभग 0.5 ग्राम प्रति लीटर पानी',
      ...
      Apple_Grey_Spot: {
        ...
        prevention: [
          ...
          '��रसात के मौसम में हर हफ्ते पत्तियाँ जाँचें',
        ],
        speech:
      ...
      Apple_Brown_Spot: {
        ...
        organic: [
          ...
          'ग��री पत्तियों पर 5% यूरिया छिड़कें ताकि वे जल्दी गल जाएँ',
          'छँटाई से हवा और धूप का रास्ता बनाएँ',
          'ऊपर से सिंचाई बिल्कुल न करें',
          'बगीचे में जल-निकासी ठीक रखें',
        ],
      ...
      Apple_Mosaic: {
        ...
        organic: [
          ...
          'ग्रस्त पेड़ से कलम कभी न लें, चाहे बाकी पेड़ अच��छा दिखे',
      ...
      Apple_Healthy: {
        ...
        speech:
          ...
          'दस से पंद्रह दिन बाद इस ऐप ��े दोबारा जाँच कर लीजिए।',
      },
    },
  },
...
async function acceptFile(file) {
  ...
  if (file.size > CONFIG.MAX_FILE_BYTES) {
    showError(
      'फोटो बह���त बड़ी है (' + (file.size / 1048576).toFixed(1) + ' MB)। ' +
...
async function addFilesToBatch(fileList) {
  ...
  if (chhoot) {
    showInfo(
      ...
      BATCH.MAX + ' फो��ो जाँची जा सकती हैं।',
...
function summariseBatch() {
  ...
  if (!scanned.length) {
    ...
    adviceHi = 'खेत के अच्छे-खासे हिस्से में रोग पहुँच चुका है। पूरे खेत में छिड़काव की ' +
               'योजना ��नाएँ और 10–15 दिन बाद दोबारा जाँचें।';
  } else {
  ...
  if (ai.label === 'not_plant') {
    showNotPlant({
      ...
      tipsHi: [
        ...
        'प��्ती को फ्रेम में पूरा भरें, 15–20 सें.मी. दूर से',
...
function renderInstallCard() {
  ...
  if (deferredInstallPrompt) {
    el.installNote.textContent =
      'ऊपर वाला बटन दबाते ही ऐप फ़ोन में जुड़ जाएगी (कुछ भी अलग से डाउन���ोड नहीं करना पड़ेगा)।';
    hide(el.installSteps);
    return;
  }
